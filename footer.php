...
?>
    ...
    <div id="footer-section" class="footer-section">
        ...
        <div class="container">
            ...
            <div class="col-md-4 col-sm-6 col-sm-push-6 col-md-push-0">
                ...
                <aside class="widget widget_about">
                    ...
                    <p>Our homes are affordable and still have the perks that come with a healthy luxurious lifestyle, hence property acquisition costs are low with juicy returns from rentals making Blissville the ideal investors destination.</p>
                </aside>
                <!-- About Widget /- -->
            </div><!-- col-md-3 -->
            ...
            <div class="col-md-4 hidden-sm hidden-xs">
                ...
                <aside class="widget widget_quick_links">
                    ...
                    <ul class="p_l-0">
                        <li><a title="Quick Links" href="http://blissville.com.ng/property.php?p=3-bedroom-apartments">3 Bedroom Apartments</a></li>
                        <li><a title="Quick Links" href="http://blissville.com.ng/property.php?p=4-bedroom-maisonettes">4 Bedroom Maisonettes</a></li>
        ...
        <div id="footer-bottom" class="footer-bottom footer-bottom2">
            <!-- container -->
            <div class="container">
                <p class="col-md-6 col-sm-8 col-xs-12">&copy; <?php echo date('Y') ?> Powered by <a href="http://highrachy.com/" style="color:white">Highrachy Investments and Techonology</a></p>
    ...
    <?php else: ?>
      <footer class="container-fluid dashboard-footer right-panel">
          Copyright © <?php echo Date('Y') ?> <a href="#" target="_blank">Highrachy</a>
            <a href="#" class="pull-right scrollToTop"><i class="fa fa-chevron-up"></i></a>
        </footer>
    <?php endif ?>

    <!-- jQuery Include -->
    <script src="<?php URL::display('assets/js/jquery.min.js') ?>"></script>
    <script src="<?php URL::display('assets/js/jquery.easing.min.js') ?>"></script><!-- Easing Animation Effect -->
    <script src="<?php URL::display('assets/js/bootstrap/bootstrap.min.js') ?>"></script> <!-- Core Bootstrap v3.2.0 -->
    <script src="<?php URL::display('assets/js/modernizr/modernizr.custom.37829.js') ?>"></script> <!-- Modernizer -->
    <script src="<?php URL::display('assets/js/jquery.bootstrap.wizard.min.js') ?>"></script> <!-- It Loads jQuery when element is appears -->
    <!-- <script src="<?php URL::display('assets/js/jquery.waypoints.min.js') ?>"></script> -->
    <script src="<?php URL::display('assets/js/wow.min.js') ?>"></script>
    <script src="<?php URL::display('assets/js/image-picker.min.js') ?>"></script>
    ...
    <?php
      ...
      if (isset($map) && (!empty($map))){ ?>
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=<?php echo GMAP_API ?>&sensor=false"></script><!-- google maps -->
    ...
    <?php
      ...
      if (isset($datetimepicker) && ($datetimepicker)){ ?>
        <!-- Date Time Picker -->
        <script src="<?php URL::display('assets/js/moment/moment.min.js') ?>"></script>
        <script src="<?php URL::display('assets/js/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js') ?>"></script>
    <?php } ?>
    ...
    <?php
      ...
      if (isset($lightbox) && ($lightbox)){ ?>
        ...
        <link href="<?php echo BASE_URL ?>assets/js/lightbox/fancybox/jquery.fancybox.css" rel="stylesheet" media="screen">
        <script src="<?php URL::display('assets/js/lightbox/fancybox/jquery.fancybox.pack.js') ?>"></script>
    <?php } ?>
    ...
    <?php
      ...
      if (isset($filterable) && ($filterable)){ ?>
        <!-- Date Time Picker -->
        <script src="<?php URL::display('assets/js/plugins/filterable/filterable.pack.js') ?>"></script>
    <?php } ?>


    <script src="<?php URL::display('assets/js/plugins.js') ?>"></script>
    <script src="<?php URL::display('assets/js/main.js') ?>"></script>
