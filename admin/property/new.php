...
if (Form::is_posted()) {
  if (Property::add()) {
    URL::redirect('admin/property/?action=add');
  } else {
      ...
      <div class="container-fluid">
            ...
            <div class="row">
              ...
              <form action="#" class="form-horizontal" method="post" enctype="multipart/form-data">
                  ...
                  <h3 class="page-title">Add a New Property<br><br></h3>

                  <div class="form-group">
                      <label class="col-sm-2 control-label">Name <span class="mandatory">*</span></label>
                      <div class="col-sm-7">
                                  <?php Form::text('name','',array('class' => "form-control", 'placeholder' => "Name of the property Area")) ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <?php Form::textarea('content','',array("class" => 'editor')) ?>
                        <?php Form::show_info('content','Enter your Property Content here') ?>
                      </div>
                  </div>

                  <div class="form-group">
                      <label class="col-sm-2 control-label">Default Picture<span class="mandatory">*</span></label>
                      <div class="col-sm-7">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <?php Form::text('price','',array('class' => "form-control", 'placeholder' => "Price of Property (One-Off) E.g 10000000")) ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <?php 
                        Form::select('portfolio_id',Portfolio::form_select(),array('class' => "form-control"));
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <?php Form::text('property_type','',array('class' => "form-control", 'placeholder' => "Type of Property")) ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <?php Form::text('location','',array('class' => "form-control", 'placeholder' => "Property Location")) ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <?php Form::text('size','',array('class' => "form-control", 'placeholder' => "E.g 255 Msq")) ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <?php Form::number('bedroom','',array('class'=>"form-control", 'min'=>'1','max'=>'10')); ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <?php Form::number('living_room','',array('class'=>"form-control", 'min'=>'1','max'=>'10')); ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <?php Form::number('kitchen','',array('class'=>"form-control", 'min'=>'1','max'=>'10')); ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <?php Form::number('toilet','',array('class'=>"form-control", 'min'=>'1','max'=>'10')); ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <?php Form::number('bathroom','',array('class'=>"form-control", 'min'=>'1','max'=>'10')); ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <?php Form::number('parking_lots','',array('class'=>"form-control", 'min'=>'1','max'=>'10')); ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <?php Form::number('priority','',array('class'=>"form-control", 'min'=>'1','max'=>'10')); ?>
