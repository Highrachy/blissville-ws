...
$total_portfolios = Page::affected_rows();
$portfolios = Page::get_results();
                  ...
                  <div class="panel panel-default">
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover responsive">
                          ...
                          <tbody>
                             <?php foreach($portfolios as $portfolio) : extract($portfolio) ?>
                            <tr>
                              ...
                              <td class="text-right">
                              <a class="btn btn-default btn-icon btn-hollow btn-xs tip pull-right" href="<?php URL::display('admin/edit-content/portfolio/edit.php?portfolio='.$portfolio['id']) ?>" title="Edit Content"><i class="fa fa-pencil"></i> &nbsp; Edit</a>
                              </td>
                            </tr>
                            <?php endforeach ?>
                          </tbody>
                    ...
                    <?php endif ?>
                      <?php else : echo '<h6>&nbsp;&nbsp;You have no portfolios in the database.</h6>'; endif ?>
                  </div>
                </div>
                <!-- content  end -->
            </div>
