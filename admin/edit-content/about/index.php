...
$total_abouts = Page::affected_rows();
$abouts = Page::get_results();
            ...
            <div class="row">
                ...
                <div id="content">
                  <div class="panel panel-default">
                        ...
                        <table class="table table-bordered table-striped table-hover responsive">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="text-right">
                              <a class="btn btn-default btn-icon btn-hollow btn-xs tip pull-right" href="<?php URL::display('admin/edit-content/about/edit.php?about='.$about['id']) ?>" title="Edit Content"><i class="fa fa-pencil"></i> &nbsp; Edit</a>
                              </td>
                            </tr>
                            <?php endforeach ?>
                          </tbody>
                    ...
                    <?php endif ?>
                      <?php else : echo '<h6>&nbsp;&nbsp;You have no abouts in the database.</h6>'; endif ?>
                  </div>
                </div>
                <!-- content  end -->
            </div>
