...
$total_homepages = Page::affected_rows();
$homepages = Page::get_results();
                  ...
                  <div class="panel panel-default">
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover responsive">
                          ...
                          <tbody>
                             <?php foreach($homepages as $homepage) : extract($homepage) ?>
                            <tr>
                              ...
                              <td class="text-right">
                              <a class="btn btn-default btn-icon btn-hollow btn-xs tip pull-right" href="<?php URL::display('admin/edit-content/homepage/edit.php?homepage='.$homepage['id']) ?>" title="Edit Content"><i class="fa fa-pencil"></i> &nbsp; Edit</a>
                              </td>
                            </tr>
                            <?php endforeach ?>
                          </tbody>
                    ...
                    <?php endif ?>
                      <?php else : echo '<h6>&nbsp;&nbsp;You have no homepages in the database.</h6>'; endif ?>
                  </div>
                </div>
                <!-- content  end -->
            </div>
