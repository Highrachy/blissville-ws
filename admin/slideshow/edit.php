...
if (isset($_GET['slideshow'])){
  ...
  if ($slideshow_id == ""){
    ...
    if (Form::is_posted()) {
      ...
      if (Slideshow::update()) {
        URL::redirect('admin/slideshow/?action=update');
      } else {
    ...
    # -- Get Slideshow Info
    $slideshow = Slideshow::get_one("WHERE id = '$slideshow_id' ");
                    ...
                    <form action="#" class="form-horizontal" method="post" enctype="multipart/form-data">
                      ...
                      <br><br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                        <?php Form::text('name',$name,array('class' => "form-control", "placeholder" => "Name of the slideshow Area")) ?>
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                <?php Form::text('price',$price,array('class' => "form-control", "placeholder" => "Price to be displayed")) ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                              <?php Form::textarea('description',$description,array("class" => 'editor')) ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <?php Form::text('link_text',$link_text,array('class' => "form-control", "placeholder" => "Link Text")) ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                <?php Form::text('link_page',$link_page,array('class' => "form-control", "placeholder" => "Link this Slide to... ")) ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <?php Form::text('buy_text',$buy_text,array('class' => "form-control", "placeholder" => "Buy Text")) ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                <?php Form::text('buy_page',$buy_page,array('class' => "form-control", "placeholder" => "This item can be bought at... ")) ?>
                            ...
                            <div class="col-sm-7">
                              <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="max-width: 100%; height: 150px;">
                                  <img src="<?php URL::display('assets/uploads/slideshow/' . $picture); ?>" data-src="<?php URL::display('assets/uploads/slideshow/' . $picture); ?>" alt="Placeholder">
                                </div>
                        ...
                        <div class="form-group">
                          <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <?php Form::hidden('slideshow_id',$slideshow_id) ?>
                            <?php Form::hidden('old_picture',$picture) ?>
                            <?php Form::submit('submit','Update Slideshow',array('class'=>"btn btn-primary")) ?> 
                            <a href="<?php URL::display("slideshow") ?>" class="btn btn-default">Cancel</a>
                          </div>
                        </div>
                    </form>
